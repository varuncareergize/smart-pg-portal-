...
/**
 * FEATURED_STAYS matches the visual style seen in Home2.jpg
 */
...
export default function Home() {
  return (
    <div className="min-h-screen bg-white">
      {/* 1. Global Navigation (Reference home1.png) */}
      <Navbar />

      {/* 2. Hero Section (Reference home1.png) */}
      ...
      {/* 3. Featured Properties (Reference Home2.jpg) */}
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex justify-between items-end mb-12">
            ...
            <button className="text-[#00C896] font-black text-sm flex items-center gap-2 hover:gap-3 transition-all uppercase tracking-widest">
              ...
              <div key={p.id} className="bg-white rounded-[40px] overflow-hidden border border-slate-100 group shadow-sm hover:shadow-xl transition-all">
                ...
                <div className="p-8">
                  <div className="flex justify-between items-start mb-6">
                    <div>
                      <h4 className="text-xl font-black text-[#001D3D]">{p.name}</h4>
                      <p className="text-xs font-bold text-slate-400 mt-2 flex items-center gap-1 uppercase tracking-widest">
                         <MapPin size={12}/> {p.location}
                      </p>
                    </div>
                    <div className="bg-green-50 text-[#00C896] font-black px-3 py-1 rounded-lg text-sm">₹{p.price}/mo</div>
                  </div>
      ...
      {/* 4. Why Choose Us (Reference Home3.png) */}
      ...
      {/* 5. Owner Call-to-Action (Reference Home4.png) */}
      <section className="py-24 px-4">
        <div className="max-w-6xl mx-auto bg-[#001D3D] rounded-[48px] p-16 md:p-24 text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-slate-400 text-lg max-w-2xl mx-auto mb-12 leading-relaxed">
              Maximize your rental yield and experience stress-free management with our professional services. We handle everything from marketing to maintenance.
            </p>
            <div className="flex flex-col md:flex-row justify-center gap-4">
              ...
              <button className="bg-white/5 text-white px-10 py-5 rounded-2xl font-black border border-white/10 hover:bg-white/10 transition-colors">
                Learn More
              </button>
            </div>
          </div>
