...
export default function Navbar() {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          >
            ...
            <span className="text-2xl font-black text-[#001D3D] tracking-tighter">
              SmartGP
            </span>
          </Link>
          ...
          <div className="hidden md:flex items-center gap-1">
            ...
            <button 
              ...
              className="bg-[#001D3D] text-white px-7 py-3.5 rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-[#00C896] hover:shadow-lg hover:shadow-green-500/20 transition-all active:scale-95"
            >
              Sign In
            </button>
          </div>
          ...
          <div className="md:hidden">
            <button 
              ...
              className="p-3 text-[#001D3D] bg-slate-50 rounded-2xl transition-colors"
            >
      ...
      <div 
        className={`md:hidden absolute w-full bg-white border-b border-slate-100 shadow-2xl transition-all duration-500 ease-in-out overflow-hidden ${
        ...
        <div className="px-6 pt-4 pb-10 space-y-2">
          ...
          <div className="pt-6">
            <button 
              ...
              className="w-full bg-[#001D3D] text-white py-5 rounded-[24px] font-black text-xs uppercase tracking-widest shadow-xl shadow-blue-900/20"
            >
              Sign In
            </button>
          </div>
