    ...
    return (
      <div className="w-full h-full min-h-[400px] flex flex-col items-center justify-center rounded-2xl border border-red-200 bg-red-50 p-6 text-center">
        ...
        <p className="text-xs text-red-500 mt-3">
          Restart your Vite server after adding the
    ...
    return (
      <div className="w-full h-full min-h-[400px] flex flex-col items-center justify-center rounded-2xl border border-red-200 bg-red-50 p-6 text-center">
        ...
        <p className="text-sm text-red-600 mt-2 max-w-md">
          Check your Google Maps API key, billing,
          Maps JavaScript API, and API key restrictions.
        </p>

        <p className="text-xs text-red-500 mt-3">
          Open your browser console for the exact
          Google Maps error.
        </p>
      </div>
    );
